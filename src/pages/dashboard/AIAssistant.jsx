        ...
        <div className="max-w-4xl mx-auto h-[calc(100vh-8rem)] flex flex-col py-4 px-3 sm:px-4 md:px-0">
            ...
            <Card className="flex-1 flex flex-col overflow-hidden bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm border-slate-200/60 dark:border-slate-800/60 shadow-xl">
                ...
                <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6 custom-scrollbar">
                    ...
                    {loading && (
                        <div className="flex items-start gap-4 flex-row animate-fadeIn">
                            <div className="w-10 h-10 rounded-full flex shrink-0 items-center justify-center shadow-sm bg-gradient-to-br from-brand-400 to-brand-600 text-white">
                                <Bot className="w-5 h-5" />
                            </div>
                            <div className="px-5 py-4 max-w-[80%] rounded-2xl rounded-tl-none bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700/50 flex items-center gap-2">
                ...
                <div className="p-4 bg-transparent border-t border-slate-200/50 dark:border-slate-800/50">
                    ...
                    >
                        <textarea
                            ...
                            className="flex-1 max-h-32 min-h-[56px] bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl py-3.5 pl-5 pr-14 focus:outline-none focus:ring-2 focus:ring-brand-500/50 resize-none text-slate-800 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 transition-all custom-scrollbar"
                            rows={1}
                        />
                        ...
                        <button
                            ...
                            className="absolute right-2 bottom-2 w-10 h-10 flex items-center justify-center rounded-xl bg-brand-500 text-white hover:bg-brand-600 disabled:opacity-50 disabled:hover:bg-brand-500 transition-all active:scale-95"
                        >
